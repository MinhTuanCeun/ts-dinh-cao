...
function floatToString(a, r) {
    ...
    return t.replace(".", Zozo.decimal),
    t.match("^[." + Zozo.decimal + "]d+") ? "0" + t : t
}
...
Zozo.getCulture = function(t) {
    var e;
    for (n = 0; n < Zozo.cultures.length; n++)
        if (Zozo.cultures[n].code == t) {
            e = Zozo.cultures[n];
            break
        }
    return e || (e = Zozo.cultures[0]),
    e
}
;
Zozo.format = Zozo.getCulture(Zozo.culture);
Zozo.money_format = "",
Zozo.each = function(t, e) {
...
Zozo.uniq = function(t) {
    for (var e = [], a = 0; a < t.length; a++)
        Zozo.arrayIncludes(e, t[a]) || e.push(t[a]);
    return e
}
;
...
Zozo.Product.prototype.optionValues = function(t) {
    if (!Zozo.isDefined(this.variants))
        return null;
...
Zozo.formatMoney = function(t, e) {
    ...
    t /= 100,
    "string" == typeof t && (t = t.replace(Zozo.format.thousands, ""));
    var r = ""
      , n = /\{\{\s*(\w+)\s*\}\}/
...
Zozo.OptionSelectors = function(t, e) {
    ...
    this.selectors = [],
    this.domIdPrefix = t,
    this.product = new Zozo.Product(e.product),
    this.onVariantSelected = Zozo.isDefined(e.onVariantSelected) ? e.onVariantSelected : function() {}
    ,
    this.replaceSelector(t),
    this.initDropdown(),
    e.enableHistoryState && (this.historyState = new Zozo.OptionSelectors.HistoryState(this)),
    !0
}
;
...
Zozo.OptionSelectors.prototype.optionExistInSelect = function(t, e) {
    for (var a = 0; a < t.options.length; a++)
        if (t.options[a].value == e)
            return !0
}
;
Zozo.OptionSelectors.prototype.insertSelectors = function(t, e) {
    Zozo.isDefined(e) && this.setMessageElement(e),
...
Zozo.OptionSelectors.prototype.updateSelectors = function(t, e) {
    ...
    null != this.historyState && this.historyState.onVariantChange(r, this, e)
}
;
Zozo.OptionSelectorsFromDOM = function(t, e) {
    ...
    e.product = o,
    Zozo.OptionSelectorsFromDOM.baseConstructor.call(this, t, e)
}
;
